...
class ShiftCanvas extends HTMLElement {
	constructor() {
		super();
	}
...
class TextArea extends HTMLElement {
	input = this.querySelector("#contact-message");
	...
	disconnectedCallback() {
		this.input.removeEventListener("input", this.handleTextChange);
	}
}

customElements.define("shift-canvas", ShiftCanvas);
